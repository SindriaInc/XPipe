...
MAGENTO_BASE_URL=https://lucapitzoi-xpipe.sindria.org
...
MAGENTO_DB_HOST=xpipe-v1-web-portal-db.xpipe-lucapitzoi.svc.cluster.local
MAGENTO_DB_NAME=app
MAGENTO_DB_USER=user
MAGENTO_DB_PASSWORD=secret

# Elasticsearch configuration
ELASTICSEARCH_HOST=xpipe-v1-web-portal-idx.xpipe-lucapitzoi.svc.cluster.local
