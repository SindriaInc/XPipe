...
MAGENTO_BASE_URL=https://dorjecurreli-xpipe.sindria.org
...
MAGENTO_DB_HOST=xpipe-v1-web-portal-db.xpipe-dorjecurreli.svc.cluster.local
MAGENTO_DB_NAME=app
MAGENTO_DB_USER=user
MAGENTO_DB_PASSWORD=secret

# Elasticsearch configuration
ELASTICSEARCH_HOST=xpipe-v1-web-portal-idx.xpipe-dorjecurreli.svc.cluster.local
...
# Rehash default users passwords
