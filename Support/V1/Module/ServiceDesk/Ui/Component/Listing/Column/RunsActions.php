...
{
    private const URL_PATH_SHOW = 'servicedesk/pipeline_run/show';
    private const URL_PATH_STOP = 'servicedesk/pipeline_run/stop';
    private const URL_PATH_DELETE = 'servicedesk/pipeline_run/delete';
