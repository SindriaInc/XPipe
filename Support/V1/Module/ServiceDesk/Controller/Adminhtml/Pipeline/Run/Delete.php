...
{
    const ADMIN_RESOURCE = 'Support_ServiceDesk::deleterun';
...
//
//            $response = $this->githubIssuesService->cancelAWorkflowRun(
//                $this->organization,
//                $params['pipeline_id'],
//                $params['run_id']
//            );
...
//            ]);
//
//            return $resultRedirect->setPath('servicedesk/pipeline/index', ['pipeline_id' => $params['pipeline_id']]);
//
//
//
//        } catch (\Exception $e) {
