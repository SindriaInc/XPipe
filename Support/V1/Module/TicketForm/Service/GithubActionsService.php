...
class GithubActionsService
{
    ...
    public function getTicketTypes(string $organization) : array
    {
        ...
        try {
            $listIssueTypesForAnOrganizationResponse = GithubFacade::listIssueTypesForAnOrganization($organization);
            $listIssueTypesForAnOrganizationResource = json_decode($listIssueTypesForAnOrganizationResponse, true);
            $result['success'] = true;
            $result['code'] = $listIssueTypesForAnOrganizationResponse->getStatusCode();
            $result['data'] = $listIssueTypesForAnOrganizationResource;
            ...
            $result['code'] = 500;
            $result['message'] = "Error while listing the issues types";
            return $result;
        }
    ...
    ) : array
    {
        ...
        try {
            ...
            $createAnIssueResponse = GithubFacade::createAnIssue($organization, $repo, $data['title'], $data['description'], ['Ticket', $data['tenant'], $data['username'], $data['fullname'], $data['email']], $data['ticket_type']);
