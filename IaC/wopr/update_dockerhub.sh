...
#kubectl delete secret sindria-dockerhub -n besteam-dev
...
kubectl delete secret sindria-dockerhub -n xpipe-besteam
...
#kubectl apply -f sindria-dockerhub.yaml -n besteam-dev
...
kubectl apply -f sindria-dockerhub.yaml -n xpipe-besteam
