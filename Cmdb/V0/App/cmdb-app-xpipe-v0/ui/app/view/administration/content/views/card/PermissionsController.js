Ext.define('CMDBuildUI.view.administration.content.views.card.PermissionsController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.administration-content-views-card-permissions',
    ...
    onEditBtnClick: function (button, event, eOpts) {
        ...
        view.up('#viewtabpanel').getViewModel().toggleEnableTabs(1);
    },
