    ...
    privates: {
        ...
        getCard: function (info, theObject) {
            ...
            return [{
                ...
                tabpaneltools: [{
                    xtype: 'tool',
                    iconCls: Ext.baseCSSPrefix + 'fa fa-external-link',
                    cls: 'management-tool',
                    ...
                    xtype: 'tool',
                    iconCls: Ext.baseCSSPrefix + 'fa fa-ellipsis-v',
                    id: 'menuTool',
                    cls: 'management-tool',
                    callback: function (owner, tool, event) {
                        if (owner.cardMenu) {
                            ...
                            var model = theObject.get("_model"),
                                ...
                                menu = Ext.create('Ext.menu.Menu', {
                                    ...
                                    items: [{
                                        iconCls: Ext.baseCSSPrefix + 'fa fa-pencil',
                                        cls: 'management-tool',
                                        ...
                                        iconCls: Ext.baseCSSPrefix + 'fa fa-th-list',
                                        cls: 'management-tool',
                                        ...
                                        iconCls: Ext.baseCSSPrefix + 'fa fa-sticky-note',
                                        cls: 'management-tool',
                                        ...
                                        iconCls: Ext.baseCSSPrefix + 'fa fa-link',
                                        cls: 'management-tool',
                                        ...
                                        iconCls: Ext.baseCSSPrefix + 'fa fa-history',
                                        cls: 'management-tool',
                                        ...
                                        iconCls: Ext.baseCSSPrefix + 'fa fa-envelope',
                                        cls: 'management-tool',
                                        ...
                                        iconCls: Ext.baseCSSPrefix + 'fa fa-paperclip',
                                        cls: 'management-tool',
