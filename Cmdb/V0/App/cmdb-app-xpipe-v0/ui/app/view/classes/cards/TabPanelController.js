            ...
            if (!isSimpleClass && classDef[CMDBuildUI.model.users.Grant.permissions.email_read]) {
                tabemails = view.add({
                    ...
                    tabConfig: {
                        ...
                        bind: {
                            text: readonly ?
                                CMDBuildUI.locales.Locales.common.tabs.emails + ' {tabcounters.emails ? "(" + tabcounters.emails + ")" : null}' : '{tabcounters.emails ? \'<span class="badge">\' + tabcounters.emails + "</span>" : null}'
                        }
                    },
                    disabled: disabletabs
                });
            ...
            if (!isSimpleClass && enabledservices.dms && classDef[CMDBuildUI.model.users.Grant.permissions.attachment_read]) {
                tabattachments = view.add({
                    ...
                    tabConfig: {
                        ...
                        bind: {
                            text: readonly ?
                                CMDBuildUI.locales.Locales.common.tabs.attachments + ' {tabcounters.attachments ? "(" + tabcounters.attachments + ")" : null}' : '{tabcounters.attachments ? \'<span class="badge">\' + tabcounters.attachments + "</span>" : null}'
                        }
                    },
                    disabled: disabletabs
                });
