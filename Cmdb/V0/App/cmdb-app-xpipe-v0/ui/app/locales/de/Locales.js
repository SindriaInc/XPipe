(function() {
    Ext.define('CMDBuildUI.locales.de.Locales', {
        ...
        "attachments": {
            ...
            "warningmessages": {
                "atleast": "{0}: {1} Anlagen vom Typ \"{2}\" wurden hogeladen. Diese Kategorie erwartet zumindest {3} Anlagen",
                "exactlynumber": "{0}: {1} Anlagen vom Typ \"{2}\" wurden hochgeladen. Diese Kategorie erwartet {3} Anlagen",
                "maxnumber": "{0}: {1} Anlagen vom Typ \"{2}\" wurden hogeladen. Diese Kategorie erwartet höchstens {3} Anlagen"
            },
        ...
        "processes": {
            ...
            "resumeprocesses": "Vorgänge, die nicht angehalten wurden, können nicht vortgesetzt werden",
