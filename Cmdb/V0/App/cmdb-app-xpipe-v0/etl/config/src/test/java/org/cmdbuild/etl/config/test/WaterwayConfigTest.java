...
public class WaterwayConfigTest {
    ...
    public void testConfigProcessing1() throws Exception {
        ...
        ProcessingReport validate = validator.validate(fromJson(readToString(getClass().getResourceAsStream("/org/cmdbuild/etl/config/schema.json")), JsonNode.class), fromJson(toJson(data), JsonNode.class));
