...
import org.cmdbuild.workflow.xpdl.XpdlDocumentHelper.ScriptLanguage;
...
public class XpdlActivity implements XpdlExtendedAttributesHolder {
	...
	public void setBlockType(final XpdlActivityHolderImpl activitySet) {
		if (activitySet != null) {
	...
	public XpdlActivityHolderImpl getBlockActivitySet() {
		if (isBlockType()) {
