...
public interface CQLBuilderListener {
	...
	void startFromDomain(String scopeReference, long domainId, String domainas, DomainDirection direction);
	 ...
	 * @param isNot
	 */
	void startDomain(WhereType type, String scopeReference, long domainId, DomainDirection direction, boolean isNot);
	 ...
	 * @param operator
	 */
	void startSimpleField(WhereType type, boolean isNot, String classOrDomainNameOrRef, String fieldId, FieldOperator operator);
	 ...
	 * @param operator
	 */
	void startComplexField(WhereType type, boolean isNot, String classOrDomainNameOrRef, String[] fieldPath, FieldOperator operator);
	 ...
	 * @param operator
	 */
	void startLookupField(WhereType type, boolean isNot, String classOrDomainNameOrRef, String fieldId, LookupOperator[] lookupPath, FieldOperator operator);
