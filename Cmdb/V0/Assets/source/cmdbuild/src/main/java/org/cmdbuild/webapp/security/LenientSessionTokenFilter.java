...
public class LenientSessionTokenFilter extends SessionTokenFilter {
    ...
    public LenientSessionTokenFilter(FilterHelperService helper, SessionService sessionService, AuthenticationService authenticationService, CustomLoginService customLoginService, FaultEventCollectorService faultEventCollectorService, RestConfiguration restConfiguration) {
