...
Ext.define('CMDBuildUI.util.helper.GridHelper', {
    ...
    getProcessFlowStatusColumn: function () {
        return {
            ...
            renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                ...
                if (value) {
                    const lookupvalue = CMDBuildUI.model.lookups.Lookup.getLookupValueById(CMDBuildUI.model.processes.Process.flowstatus.lookuptype, value);
                    if (lookupvalue) {
                        ...
                        if (lookupvalue.get("icon_font")) {
                            ...
                            icon = CMDBuildUI.util.helper.IconHelper.getIconId(icon_font_splitted[0], icon_font_splitted.length > 1 ? icon_font_splitted[1] : '');
                        }
    ...
    getStoreSorters: function (object, sortByDescription) {
        var sorters = [],
            preferences = object ? CMDBuildUI.util.helper.UserPreferences.getGridPreferences(object.objectType, object.getId()) : {};
