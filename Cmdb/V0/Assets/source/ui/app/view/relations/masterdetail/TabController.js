    ...
    onTargetDataUpdated: function (view, targetTypeObject, targetTypeModel, domain, eOpts) {
            ...
            view.add({
                ...
                controller: {
                    ...
                    onAfterRender: function (view, eOpts) {
                        if (!Ext.isNumber(vm.get("mditems"))) {
                            view.getView().setLoading(true);
                        }
                    }
                },
                viewModel: {
            ...
            for (var i = 0; i < children.length; i++) {
                ...
                menu.push({
                    ...
                    disabled: !child.get(CMDBuildUI.model.base.Base.permissions.edit) ||
                        (domain.get("cardinality") === CMDBuildUI.model.domains.Domain.cardinalities.onetomany && Ext.Array.contains(Ext.Array.from(domain.get("disabledDestinationDescendants")), child.getId())) ||
                        (domain.get("cardinality") === CMDBuildUI.model.domains.Domain.cardinalities.manytoone && Ext.Array.contains(Ext.Array.from(domain.get("disabledSourceDescendants")), child.getId())),
                    type: child.get("name")
                });
            }
        ...
        vm.bind("{records}", function (records) {
            records.addListener("load", function () {
                ...
                view.down("#mdgrid").getView().setLoading(false);
            });
        });
    },
                ...
                config = {
                    ...
                    buttons: [{
                        ...
                        handler: function (btn, event) {
                            ...
                            panel.down("classes-cards-card-create").getController().saveForm({
                                failure: function () {
            ...
            config = {
                ...
                buttons: [{
                    ...
                    handler: function (btn, event) {
                        ...
                        popup.down("classes-cards-card-edit").getController().saveForm({
                            failure: function () {
                                CMDBuildUI.util.helper.FormHelper.endSavingForm();
                                CMDBuildUI.util.Utilities.enableFormButtons([btn, cancelBtn]);
                            }
