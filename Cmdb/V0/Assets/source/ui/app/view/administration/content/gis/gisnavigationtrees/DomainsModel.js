Ext.define('CMDBuildUI.view.administration.content.gis.gisnavigationtrees.DomainsModel', {
    extend: 'Ext.app.ViewModel',
    alias: 'viewmodel.administration-content-gis-gisnavigationtrees-domains',
    data: {
        treeRoot: null
    },
    formulas: {
        ...
        treeRoot: {
            ...
            get: function (data) {
                ...
                node.subclassFilter = root.subclassFilter;
                node.subclassViewShowIntermediateNodes = root.subclassViewShowIntermediateNodes;
                node.subclassViewMode = root.subclassViewMode;
                Ext.Array.forEach(Ext.Object.getKeys(root), function (key) {
