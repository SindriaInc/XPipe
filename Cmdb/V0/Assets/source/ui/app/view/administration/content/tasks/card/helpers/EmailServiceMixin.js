            ...
            _form.getFields().items.forEach(function (field) {
                ...
                switch (fieldName) {
                    ...
                    case 'config.action_notification_template':
                        ...
                        break;
                    case 'action_notification_attachments_mode':
                        if (form.down('[name="action_notification_active"]').getValue() !== false && form.down('[name="action_notification_attachments_active"]').getValue() !== false) {
                            me.setAllowBlank(field, false, _form);
                        } else {
                            me.setAllowBlank(field, true, _form);
                        }
