...
MAGENTO_BASE_URL=https://dev-xpipe.sindria.org
...
MAGENTO_DB_HOST=academy-v1-web-portal-db.xpipe-dev.svc.cluster.local
MAGENTO_DB_NAME=app
MAGENTO_DB_USER=user
MAGENTO_DB_PASSWORD=secret

# Elasticsearch configuration
ELASTICSEARCH_HOST=academy-v1-web-portal-idx.xpipe-dev.svc.cluster.local
