...
MAGENTO_BASE_URL=https://lucapitzoi-api-lab-xpipe.sindria.org
...
MAGENTO_DB_HOST=lab-v1-api-collector-db.xpipe-lucapitzoi.svc.cluster.local
MAGENTO_DB_NAME=app
MAGENTO_DB_USER=user
MAGENTO_DB_PASSWORD=secret

# Elasticsearch configuration
ELASTICSEARCH_HOST=lab-v1-api-collector-idx.xpipe-lucapitzoi.svc.cluster.local
