...
do
  ...
  # arm64
	bash build.sh ${IMAGE_NAME} ${TAG_VERSION} ${QEMU_VERSION} arm64
  docker tag ${IMAGE_NAME}:${TAG_VERSION}-${QEMU_VERSION}-arm64 ${IMAGE_NAME}:${TAG_VERSION}-${QEMU_VERSION}-arm64v8
