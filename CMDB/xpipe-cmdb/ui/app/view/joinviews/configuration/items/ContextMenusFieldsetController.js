Ext.define('CMDBuildUI.view.joinviews.configuration.items.ContextMenusFieldsetController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.joinviews-configuration-items-contextmenusfieldset',
    ...
    onAddNewContextMenuBtn: function (view, rowIndex, colIndex) {
        ...
        var contexstMenus = vm.get('theView.contextMenuItems');
        ...
        vm.set('contextMenuCount', contexstMenus.data.length);
