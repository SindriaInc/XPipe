Ext.define('CMDBuildUI.view.history.Grid', {
    ...
    columns: [{
        ...
        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
            switch (value) {
                case 'card':
                    return Ext.String.format('<span class="x-fa fa-file-o" data-qtip="{0}"></span>', CMDBuildUI.locales.Locales.common.tabs.card);
                case 'reference':
                    return Ext.String.format('<span class="x-fa fa-file-text-o" data-qtip="{0}"></span>', CMDBuildUI.locales.Locales.history.referencerelation);
                case 'relation':
                    return Ext.String.format('<span class="x-fa fa-list" data-qtip="{0}"></span>', CMDBuildUI.locales.Locales.history.otherrelations);
                case 'system':
                    return Ext.String.format('<span class="x-fa fa-cog" data-qtip="{0}"></span>', CMDBuildUI.locales.Locales.history.system);
                default:
                    break;
            }
            return value;
