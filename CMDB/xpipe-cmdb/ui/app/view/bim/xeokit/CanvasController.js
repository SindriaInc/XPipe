    ...
    */
    onModalityNavigation: function (tool) {
        ...
        if (cameraControl.navMode === 'orbit') {
            ...
            tool.setIconCls(Ext.baseCSSPrefix + 'fa fa-repeat');
            tool.setTooltip(CMDBuildUI.locales.Locales.bim.menu.rotateXeokit);
        } else {
            cameraControl.navMode = 'orbit';
            tool.setIconCls(Ext.baseCSSPrefix + 'fa fa-arrows');
    ...
    onTooltipHelp: function (tool) {
        var html = "",
            rowTpl = '<div><i class="fa fa-{0}"></i> {1}</div>';
        ...
        // Zoom in
        html += Ext.String.format(rowTpl, Ext.baseCSSPrefix + 'fa fa-plus-square-o', CMDBuildUI.locales.Locales.bim.menu.shortcuts.zoomin);
        // Zoom out
        html += Ext.String.format(rowTpl, Ext.baseCSSPrefix + 'fa fa-minus-square-o', CMDBuildUI.locales.Locales.bim.menu.shortcuts.zoomout);
        // Key left
        html += Ext.String.format(rowTpl, Ext.baseCSSPrefix + 'fa fa-arrow-left', CMDBuildUI.locales.Locales.bim.menu.shortcuts.left);
        // Key right
        html += Ext.String.format(rowTpl, Ext.baseCSSPrefix + 'fa fa-arrow-right', CMDBuildUI.locales.Locales.bim.menu.shortcuts.right);
        // Key up
        html += Ext.String.format(rowTpl, Ext.baseCSSPrefix + 'fa fa-arrow-up', CMDBuildUI.locales.Locales.bim.menu.shortcuts.up);
        // Key down
        html += Ext.String.format(rowTpl, Ext.baseCSSPrefix + 'fa fa-arrow-down', CMDBuildUI.locales.Locales.bim.menu.shortcuts.down);
