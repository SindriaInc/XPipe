Ext.define('CMDBuildUI.view.administration.content.views.card.PermissionsModel', {
    extend: 'Ext.app.ViewModel',
    alias: 'viewmodel.administration-content-views-card-permissions',
    data: {
        actions: {
            view: true,
            edit: false,
        ...
        proxyurl: {
            ...
            get: function (data) {
                if (data.theViewFilter) {
                    if (!data.theViewFilter.phantom) {
                        return Ext.String.format('/roles/_ALL/grants/by-target/view/{0}', data.theViewFilter.get('name'));
                    }
                }
            }
        }
