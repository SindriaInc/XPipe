Ext.define('CMDBuildUI.view.administration.content.menunavigationtree.ViewController', {
                ...
                if (btnText === "yes") {
                    ...
                    me.getViewModel().get('theNavigationtree').erase({
                        success: function (record, operation) {
                            var nextUrl = 'administration/menunavigationtrees_empty/false';
    ...
    onCancelBtnClick: function (button, e, eOpts) {
        if (this.getViewModel().get('actions.edit')) {
            this.redirectTo(Ext.String.format('administration/menunavigationtrees/{0}', this.getViewModel().get('theNavigationtree.name')), true);
        ...
        var node = treeView.getStore().getRootNode();
            ...
            Ext.Ajax.request({
                ...
                success: function (record, transport) {                   
                    me.redirectTo(Ext.String.format('administration/menunavigationtrees/{0}', me.getViewModel().get('theNavigationtree.name')), true);
                },
    ...
    onSaveBtnClick: function (button, e, eOpts) {
        ...
        if (form.isValid()) {
            ...
            Ext.Ajax.request({
                ...
                jsonData: data,
                success: function (record, transport) {
                    var nextUrl = Ext.String.format('administration/menunavigationtrees/{0}', vm.get('theNavigationtree.name'));
