Ext.define('CMDBuildUI.view.administration.content.menunavigationtrees.ViewModeFormController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.administration-content-menunavigationtrees-viewmodeform',
    ...
    onSaveBtnClick: function (button) {
        ...
        view.up().fireEventArgs('close', [record]);
