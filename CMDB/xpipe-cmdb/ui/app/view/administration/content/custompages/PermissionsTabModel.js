Ext.define('CMDBuildUI.view.administration.content.custompages.PermissionsTabModel', {
    extend: 'Ext.app.ViewModel',
    alias: 'viewmodel.administration-content-custompages-permissionstab',
    data: {
        actions: {
            view: true,
            edit: false,
    ...
    formulas: {
        ...
        proxyurl: {
            bind: {
                id: '{theCustompage._id}',
                name: '{theCustompage.name}'
            },
            get: function (data) {
                if (data.id && data.name) {
                    return Ext.String.format('/roles/_ALL/grants/by-target/custompage/{0}', data.id);
                }
            }
        }
    },
