                ...
                columns: [{
                    ...
                    items: [{
                        ...
                        handler: function (grid, rowIndex, colIndex, item, event, record) {
                            var vm = grid.up('administration-content-classes-tabitems-properties-properties').lookupViewModel();
                            var translationCode = CMDBuildUI.util.administration.helper.LocalizationHelper.getLocaleKeyOfClassFormWidgetItem(vm.get('theObject.name'), grid.getStore().getAt(rowIndex).get('WidgetId'));
