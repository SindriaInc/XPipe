Ext.define('CMDBuildUI.mixins.grids.ContextMenuMixin', {
        ...
        if (config.addMultiselection) {
            ...
            menu.push({
                ...
                bind: {
                    ...
                    disabled: '{contextmenu.multiselection.disabledbtn}'
                }
            });
        }
    ...
    privates: {
        ...
        changeMultiSelectionMap: function (grid, selectionMode, enableInfoWindow) {
            var listTabSelModel = grid.getListTab().getSelectionModel(),
            ...
            if (selectionMode !== "SIMPLE") {
                var olMap = viewMap.getOlMap().getView(),
                    center = olMap.getCenter();
                olMap.animate({
                    center: [center[0] + (olMap.getMaxZoom() / olMap.getZoom()), center[1]],
                    duration: 500
                });
            }
        }
