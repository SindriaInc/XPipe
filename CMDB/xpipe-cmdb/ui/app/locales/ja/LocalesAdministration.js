    ...
    "administration": {
        "attributes": {
            ...
            "fieldlabels": {
                ...
                "domain": "ドメイン",
                "editortype": "エディタタイプ",
                "enablesorting": "ソート有効化",
                "excludefromgrid": "リストから除外",
                "filter": "フィルター",
                "format": "フォーマット",
            ...
            "strings": {
                ...
                "allusers": "全ユーザー",
                "any": "すべての",
                "attributeispresentindefaultorder": "デフォルトのクラスソートで使用されるため、ソートを無効にすることはできません",
                "coordinates": "コーディネート",
                ...
                "formulawarningmessage": "属性がリストから除外されていない場合、データの読み込みに時間がかかる場合があります。",
                "hidden": "非表示",
                "htmlall": "HTML全て",
                "htmlsafe": "HTMLセーフ",
                "immutable": "イミュータブル",
                ...
                "thefieldcantbecheckedifcheckedexcludefromgrid": "このフィールドは、「リストから除外する」フィールドがチェックされている場合、チェックすることができません",
                "thefieldexcludefromgridcantbechecked": "このフィールドは、「リストに表示する」または「省略リストに表示する」がチェックされている場合は、チェックできません",
        ...
        "classes": {
            "fieldlabels": {
                ...
                "barcodesearchattriubte": "バーコード/RFID検索条件",
        ...
        "customcomponents": {
            "emptytexts": {
                "scriptcodeempty": "Groovyスクリプト入力、スクリプトの出力は、変数 ouptut に代入する必要があります。Eg. output = \"Hello CMDBuild\"",
        ...
        "domains": {
            ...
            "fieldlabels": {
                ...
                "destination": "宛先",
                "destinationfilter": "宛先の追加／編集フィルター",
        ...
        "localizations": {
            ...
            "lookup": "ルックアップ",
            "menuinfomessage": "カスタムラベルを持つフォルダーとメニュー項目のみを表示しています。その他のメニュー項目は、元の説明文が表示されます。",
            "menuitem": "メニュー項目",
            "pdf": "PDF",
            "process": "プロセス",
            "report": "レポート",
        ...
        "systemconfig": {
            ...
            "maxsize": "最大サイズ(MB)",
            "mimetypes": "MIMEタイプ",
            "mobilenotificationauthinfo": "Tecnoteca社から提供された認証JSONをここに挿入してください",
            "module": "モジュール",
            ...
            "xktconversiontimeout": "XKTからIFC変換タイムアウト"
        },
        "tasks": {
            "account": "アカウント",
        ...
        "users": {
            ...
            "messages": {
                ...
                "ignoretenantswarningmsg": "警告! 1つまたは複数のテナントが有効になっています。一部のユーザーが表示されない場合があります。",
