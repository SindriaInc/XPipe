    ...
    getMenuItems: function () {
        ...
        if (me.sortable) {
            menuItems = [{
                itemId: 'ascItem',
                text: me.sortAscText,
                iconCls: Ext.baseCSSPrefix + 'fa fa-sort-alpha-asc',
                handler: me.onSortAscClick,
                scope: me
            }, {
                itemId: 'descItem',
                text: me.sortDescText,
                iconCls: Ext.baseCSSPrefix + 'fa fa-sort-alpha-desc',
                ...
                items: [
                    {
                        ...
                        xtype: 'tool',
                        itemId: 'sortAsc',
                        iconCls: Ext.baseCSSPrefix + 'fa fa-sort-amount-asc',
                        ...
                        xtype: 'tool',
                        itemId: 'sortDesc',
                        iconCls: Ext.baseCSSPrefix + 'fa fa-sort-amount-desc',
