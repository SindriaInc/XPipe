...
public abstract class ForwardingValueSet extends ForwardingObject implements DatabaseRecordValues {
	...
	@Override
	protected abstract DatabaseRecordValues delegate();
	...
	public Iterable<Entry<String, Object>> getAttributeValues() {
		return delegate().getAttributeValues();
	}
