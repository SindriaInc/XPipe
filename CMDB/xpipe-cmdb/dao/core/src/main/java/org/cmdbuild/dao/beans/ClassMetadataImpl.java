...
public class ClassMetadataImpl extends EntryTypeMetadataImpl implements ClassMetadata {
    ...
    private final String helpMessage, flowStatusAttr, messageAttr, dmsCategory, validationRule, flowProvider, uiRoutingTarget, uiRoutingCustom, barcodeSearchAttr, barcodeSearchRegex;
