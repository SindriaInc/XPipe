...
public class RolePrivilegeUtils {
    ...
    private static final PrivilegeProcessor<RolePrivilege> ROLE_PRIVILEGE_PROCESSOR = PrivilegeProcessorImpl.<RolePrivilege>builder().withPrivilegeImplicationMap(map(RP_ADMIN_ALL, set(
            ...
            RP_ADMIN_UICOMPONENTS_MODIFY, RP_ADMIN_CORECOMPONENTS_MODIFY, RP_ADMIN_CALENDAR_MODIFY, RP_ADMIN_ETL_MODIFY),
            RP_ADMIN_ALL_READONLY, set(RP_ADMIN_ACCESS, RP_DATA_ALL_READ, RP_REPORT_ALL_READ, RP_VIEW_ALL_READ,
                    ...
                    RP_ADMIN_UICOMPONENTS_VIEW, RP_ADMIN_CORECOMPONENTS_VIEW, RP_ADMIN_CALENDAR_VIEW, RP_ADMIN_ETL_VIEW),
            RP_BASE_ALL, set(RP_BASE_ACCESS, RP_BULKUPDATE_ACCESS, RP_CHAT_ACCESS, RP_CHANGEPASSWORD_ACCESS, RP_CLASS_ACCESS, RP_CUSTOMPAGES_ACCESS, RP_DASHBOARD_ACCESS, RP_DATAVIEW_ACCESS, RP_EXPORTCSV_ACCESS,
