 ...
 */
@Component
public class PasswordUserScriptService implements UserScriptService {
    ...
    public PasswordUserScriptService(GroovyScriptService scriptService, CmApiService apiService) {
    ...
    public LoginUserIdentity getLoginFromScript(LoginModuleConfiguration authConf, Logger customLogger, Object loginData) {
        try {
            ...
            Map<String, Object> out = scriptService.executeScript(authConf.getLoginHandlerScript(), map(
                    ...
                    "logger", customLogger,
                    "username", (String) ((Map<String, String>) loginData).get("username"),
                    "password", (String) ((Map<String, String>)loginData).get("password"),
                    "login", null
            ));
