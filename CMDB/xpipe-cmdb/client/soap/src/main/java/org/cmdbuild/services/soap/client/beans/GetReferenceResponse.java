 ...
 *       &lt;sequence&gt;
 *         &lt;element name="return" type="{http://soap.services.cmdbuild.org}reference" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetReferenceResponse {
    ...
    protected List<Reference> _return;
     ...
     * 
     */
    public List<Reference> getReturn() {
        if (_return == null) {
            _return = new ArrayList<Reference>();
        }
        return this._return;
    }
