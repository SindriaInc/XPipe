...
public class EmailSenderGoogle extends EmailSenderJavaMail {
    ...
    public EmailSenderGoogle(EmailAccount emailAccount,
    ...
    @Override
    protected EmailSmtpSessionProvider buildEmailSmtpSessionProvider(
            EmailAccount emailAccount, @Nullable Integer smtpTimeoutSeconds,
            Logger logger) throws MessagingException {
        return new EmailSmtpSessionGoogleProvider(emailAccount,
                                                  smtpTimeoutSeconds, logger);
    }
}
