...
import org.cmdbuild.model.data.EntryTypeBean.ClassBuilder;
...
public class ClassTest {
	...
	private static EntryTypeBean a(final ClassBuilder classBuilder) {
	...
	private ClassBuilder newSimpleTable() {
		return newValidClass().withTableType(EntryTypeBean.TableType.simpletable);
	}

	private ClassBuilder newClass() {
		return EntryTypeBean.newClass();
	}
