...
public class XpdlActivityHolderImpl implements XpdlActivityHolder {

	final XpdlProcess process;
	final ActivitySet inner;
	private final XpdlActivities activities;

	XpdlActivityHolderImpl(final XpdlProcess process, final ActivitySet activitySet) {
	...
	public List<XpdlActivity> getAllActivities() {
		return process.getAllActivities();
	}
