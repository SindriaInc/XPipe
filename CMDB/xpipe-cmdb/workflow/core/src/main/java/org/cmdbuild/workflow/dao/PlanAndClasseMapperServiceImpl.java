...
import org.cmdbuild.workflow.utils.BshTaskPerformerExpressionProcessor;
import org.cmdbuild.workflow.utils.TaskPerformerExpressionProcessor;
...
public class PlanAndClasseMapperServiceImpl implements PlanAndClasseMapperService {
    ...
    public PlanAndClasseMapperServiceImpl(PlanService planService, EasytemplateProcessor easytemplateProcessor, WorkflowConfiguration configuration, CacheService cacheService, EventBusService eventBusService) {
            ...
            for (TaskPerformer performer : task.getPerformers()) {
                switch (performer.getType()) {
                    ...
                    case EXPRESSION:
                        ...
                        logger.debug("load role performers from expr =< {} > resolved as =< {} > for task = {} roles =< {} >", expression, resolvedExpression, task, performer.getValue());
