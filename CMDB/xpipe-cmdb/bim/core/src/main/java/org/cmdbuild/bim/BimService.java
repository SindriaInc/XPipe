...
public interface BimService extends BimObjectRepository, BimProjectRepository {
    ...
    void copyBimserverIfcToDatabase(long projectId);

    BimProject uploadIfcFile(long projectId, DataHandler dataHandler, @Nullable String ifcFormat, boolean isNewProject);
    ...
    default BimProject uploadIfcFile(long projectId, DataHandler dataHandler, @Nullable String ifcFormat){
        return uploadIfcFile(projectId, dataHandler, ifcFormat, true);
    }
