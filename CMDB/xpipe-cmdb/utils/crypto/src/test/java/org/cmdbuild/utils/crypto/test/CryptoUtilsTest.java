...
public class CryptoUtilsTest {
    ...
    public void testCustomKey1() throws Exception {
        ...
        String value = "passwordOne";
        String encryptedValue = Cm3EasyCryptoUtils.customtUtils("custom".getBytes()).encryptValue(value);
        assertNotEquals(encryptedValue, value);
        ...
        String decryptedValue = Cm3EasyCryptoUtils.customtUtils("custom".getBytes()).decryptValue(encryptedValue);
        assertEquals(decryptedValue, value);
