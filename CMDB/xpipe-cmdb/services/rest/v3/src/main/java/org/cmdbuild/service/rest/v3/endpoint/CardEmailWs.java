...
public class CardEmailWs {
    ...
    @POST
    @Path("{" + EMAIL_ID + "}/send")
    public Object send(@PathParam(CLASS_ID) String classId, @PathParam(CARD_ID) Long cardId, @PathParam(EMAIL_ID) Long emailId, @QueryParam("upload_template_attachments") @DefaultValue(FALSE) Boolean uploadTemplateAttachments, @QueryParam("template_only") @DefaultValue(FALSE) Boolean templateOnly) {
