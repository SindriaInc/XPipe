...
public interface Webservices {
	...
	public Card getCard(@WebParam(name = "className") String className, @WebParam(name = "cardId") Long cardId,
	...
	public CardList getCardHistory(@WebParam(name = "className") String className,
			@WebParam(name = "cardId") long cardId, @WebParam(name = "limit") Long limit,
			@WebParam(name = "offset") Long offset);

	public long createCard(@WebParam(name = "cardType") Card cardType);

	public boolean updateCard(@WebParam(name = "card") Card card);

	public boolean deleteCard(@WebParam(name = "className") String className, @WebParam(name = "cardId") long cardId);

	public long createLookup(@WebParam(name = "lookup") Lookup lookup);

	public boolean deleteLookup(@WebParam(name = "lookupId") long lookupId);

	public boolean updateLookup(@WebParam(name = "lookup") Lookup lookup);

	public Lookup getLookupById(@WebParam(name = "id") long id);
	...
	public List<Relation> getRelationList(@WebParam(name = "domain") String domain,
			@WebParam(name = "className") String className, @WebParam(name = "cardId") long cardId);
	...
	public Attachment[] getAttachmentList(@WebParam(name = "className") String className,
			@WebParam(name = "cardId") long cardId);

	@XmlMimeType("application/octet-stream")
	public boolean uploadAttachment(@WebParam(name = "className") String className,
			@WebParam(name = "objectid") long objectid, @WebParam(name = "file") DataHandler file,
	...
	public DataHandler downloadAttachment(@WebParam(name = "className") String className,
			@WebParam(name = "objectid") long objectid, @WebParam(name = "filename") String filename);

	public boolean deleteAttachment(@WebParam(name = "className") String className,
			@WebParam(name = "cardId") long cardId, @WebParam(name = "filename") String filename);
	...
	public Reference[] getReference(@WebParam(name = "className") String className,
			...
			@WebParam(name = "limit") Long limit, @WebParam(name = "offset") Long offset,
