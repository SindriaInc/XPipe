...
import org.cmdbuild.model.data.DomainBean.DomainBuilder;
...
public class DomainTest {
	...
	public void nameIdClass1AndIdClass2AreTheOnlyRequirements() {
		final DomainBean domain = a(newDomain() //
				.withName(NAME) //
	...
	private static DomainBean a(final DomainBuilder domainBuilder) {
