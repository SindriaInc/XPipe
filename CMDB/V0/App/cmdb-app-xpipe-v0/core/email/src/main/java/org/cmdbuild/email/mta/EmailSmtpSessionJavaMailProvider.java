...
/**
 * Autocloseable transport for an SMTP {@link javax.mail.Session} on given
...
public class EmailSmtpSessionJavaMailProvider implements EmailSmtpSessionProvider {
    ...
    /**
     * Autocloseable transport for an IMAP {@link javax.mail.Session} on given
     * <code>emailAccount</code>
     *
     * If correctly constructed, the contained {@link javax.mail.Transport} is
