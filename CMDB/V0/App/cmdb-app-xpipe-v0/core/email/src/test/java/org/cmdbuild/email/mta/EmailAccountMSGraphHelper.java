...
public class EmailAccountMSGraphHelper {
    ...
    private static final String A_KNOWN_MICROSOFT365_USER_EMAIL = "testtecnoteca@cmdbuild.onmicrosoft.com";
    private static final String A_KNOWN_MICROSOFT365_DELEGATED_USER_EMAIL = "testtecnoteca@cmdbuild.onmicrosoft.com";
    ...
    private static final String A_KNOWN_MICROSOFT365_APPLICATION_OAUTH2_DELEGATED_CONFIG;
    ...
    private static final String A_KNOWN_MICROSOFT365_APPLICATION_OAUTH2_CLIENT_SECRET_CONFIG;
    private static final String A_KNOWN_MICROSOFT365_APPLICATION_OAUTH2_CLIENT_CERTIFICATE_PRIVATE_KEY;
    ...
    private static final String A_KNOWN_MICROSOFT365_APPLICATION_OAUTH2_CLIENT_CERTIFICATE_CERTIFICATE;
    ...
    static {
        A_KNOWN_MICROSOFT365_APPLICATION_OAUTH2_DELEGATED_CONFIG = loadCredentialsStr(
                A_KNOWN_MICROSOFT365_APPLICATION_OAUTH2_DELEGATED_CONFIG_FILE_PATH, EmailAccountMSGraphHelper.class.getName());

        A_KNOWN_MICROSOFT365_APPLICATION_OAUTH2_CLIENT_SECRET_CONFIG = loadCredentialsStr(
                A_KNOWN_MICROSOFT365_APPLICATION_OAUTH2_CLIENT_SECRET_CONFIG_FILE_PATH, EmailAccountMSGraphHelper.class.getName());

        A_KNOWN_MICROSOFT365_APPLICATION_OAUTH2_CLIENT_CERTIFICATE_PRIVATE_KEY = loadCredentialsStr(
                A_KNOWN_MICROSOFT365_APPLICATION_OAUTH2_CLIENT_CERTIFICATE_PRIVATE_KEY_FILE_PATH, EmailAccountMSGraphHelper.class.getName());

        A_KNOWN_MICROSOFT365_APPLICATION_OAUTH2_CLIENT_CERTIFICATE_CERTIFICATE = loadCredentialsStr(
                A_KNOWN_MICROSOFT365_APPLICATION_OAUTH2_CLIENT_CERTIFICATE_CERTIFICATE_FILE_PATH, EmailAccountMSGraphHelper.class.getName());
    }
    ...
    static EmailAccount buildEmailAccount_Delegated() {
        ...
        return buildEmailAccount(msConfigs, A_KNOWN_MICROSOFT365_DELEGATED_USER_EMAIL);
    }
