...
public class EmailProviderStrategyTest {
    ...
    public void testBuildSender_Default() {
        ...
        // act: 
        EmailSenderProvider result = instance.buildSender(emailAccount,
                                                          mockEmailQueueConfiguration(),
                                                          new MockInstanceInfoService(),
    ...
    public void testBuildSender_MicrosoftDelegate() {
        ...
        assertTrue(
                ((EmailSenderMSGraph) result).emailMsGraphClientProvider instanceof EmailMSGraphClient_Password);
    }
    ...
    public void testBuildSender_MicrosoftClientSecret() {
        ...
        assertTrue(result instanceof EmailSenderMSGraph);
        assertTrue(
                ((EmailSenderMSGraph) result).emailMsGraphClientProvider instanceof EmailMSGraphClient_ClientSecret);
    }
    ...
    public void testBuildSender_MicrosoftClientCertificate() {
        ...
        assertTrue(result instanceof EmailSenderMSGraph);
        assertTrue(
                ((EmailSenderMSGraph) result).emailMsGraphClientProvider instanceof EmailMSGraphClient_ClientCertificate);
    }
    ...
    public void testBuildSender_Unhandled() {
        ...
        EmailAccount emailAccount = EmailAccountImpl.builder().withAuthenticationType(
                aUnknownAuth)
                .withPassword(PASSWORD_MS_DELEGATE)
                .build();
        EmailProviderStrategy instance = new EmailProviderStrategy();
        ...
        exceptionRule.expectMessage(format(
                "sender unsupported authentication type =< %s >", aUnknownAuth));
        instance.buildSender(emailAccount,
                             mockEmailQueueConfiguration(),
                             new MockInstanceInfoService(),
                             mockEmailSignatureService());
    }
    ...
    public void testBuildReceiver_Default() {
        ...
        // act: 
        EmailReceiverProvider result = instance.buildReceiver(emailAccount,
    ...
    public void testBuildReceiver_MicrosoftDelegate() {
        ...
        assertTrue(
                ((EmailReceiverMSGraph) result).emailMsGraphClientProvider instanceof EmailMSGraphClient_Password);
    }
    ...
    public void testBuildReceiver_Unhandled() {
        ...
        exceptionRule.expect(EmailException.class);
        exceptionRule.expectMessage(format(
                "receiver unsupported authentication type =< %s >", aUnknownAuth));
        instance.buildReceiver(emailAccount,
                               mockEmailReceiveConfig_DoNothing(),
                               mockLockService(),
                               mockEmailRepository());
    }
    ...
    public void testBuildReceiver_MicrosoftClientSecret() {
        ...
        assertTrue(result instanceof EmailReceiverMSGraph);
        assertTrue(
                ((EmailReceiverMSGraph) result).emailMsGraphClientProvider instanceof EmailMSGraphClient_ClientSecret);
    }
    ...
    public void testBuildReceiver_MicrosoftClientCertificate() {
        ...
        assertTrue(result instanceof EmailReceiverMSGraph);
        assertTrue(
                ((EmailReceiverMSGraph) result).emailMsGraphClientProvider instanceof EmailMSGraphClient_ClientCertificate);
    }
