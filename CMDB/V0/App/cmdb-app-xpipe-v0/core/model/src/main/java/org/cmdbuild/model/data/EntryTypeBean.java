...
public class EntryTypeBean {
	...
	public static class ClassBuilder implements Builder<EntryTypeBean> {
	...
	private EntryTypeBean(final ClassBuilder builder) {
