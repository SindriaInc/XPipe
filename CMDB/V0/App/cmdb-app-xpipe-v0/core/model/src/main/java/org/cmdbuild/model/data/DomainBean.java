 ...
 *
 * @author davide
 * @deprecated used with old jsonp api, to be removed in 30
 */
@Deprecated
public class DomainBean {
	 ...
	 */
	@Deprecated
	public static class DomainBuilder implements Builder<DomainBean> {
		...
		private Collection<String> disabled1;
		private Collection<String> disabled2;
		...
		public DomainBuilder withDisabled1(final Iterable<String> disabled1) {
			this.disabled1 = toList(disabled1);
			return this;
		}

		public DomainBuilder withDisabled2(final Iterable<String> disabled2) {
			this.disabled2 = toList(disabled2);
			return this;
		}

		@Override
		public DomainBean build() {
	...
	private final Collection<String> disabled1;
	private final Collection<String> disabled2;

	public static DomainBuilder newDomain() {
		return new DomainBuilder();
	}

	private DomainBean(final DomainBuilder builder) {
	...
	public Collection<String> getDisabled1() {
		return disabled1;
	}

	public Collection<String> getDisabled2() {
		return disabled2;
	}
