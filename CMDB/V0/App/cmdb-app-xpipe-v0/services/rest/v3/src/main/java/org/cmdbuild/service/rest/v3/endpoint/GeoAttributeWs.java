...
public class GeoAttributeWs {
    ...
    public GeoAttributeWs(GisService service, CoreConfiguration coreConfiguration, EasyuploadService easyuploadService, UserClassService userClassService, ObjectTranslationService translationService) {
