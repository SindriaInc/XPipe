Ext.define('CMDBuildUI.view.history.GridController', {
    ...
    onCollapseBody: function(rowNode, record, expandRow, eOpts) {
        ...
        var widget = view.liveRowContexts[record.internalId].widgets[plugin.getId() + '-' + view.getView().getId()];

        delete view.liveRowContexts[record.internalId].widgets[plugin.getId() + '-' + view.getView().getId()];
        delete view.liveRowContexts[record.internalId].viewModel;
        widget.destroy();
    },
                    ...
                    callback: function (options, success, response) {
                        if (success) {
                            ...
                            Ext.Array.forEach(data, function (item, index, allitems) {
                                ...
                                CMDBuildUI.util.helper.FormHelper.getReadOnlyField(modelField);
                                ...
                                if (modelField && modelField.attributeconf && modelField.attributeconf.password) {
                                    item._newValue = "*****";
                                } else if (modelField.cmdbuildtype === CMDBuildUI.util.helper.ModelHelper.cmdbuildtypes.file) {
