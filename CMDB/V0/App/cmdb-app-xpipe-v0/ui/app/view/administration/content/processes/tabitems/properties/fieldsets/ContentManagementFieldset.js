Ext.define('CMDBuildUI.view.administration.content.processes.tabitems.properties.fieldsets.ContentManagementFieldset', {
    extend: 'Ext.panel.Panel',
    reguires: [
        'CMDBuildUI.view.administration.content.processes.tabitems.properties.fieldsets.ContentManagementFieldsetModel'
    ],
    alias: 'widget.administration-content-processes-tabitems-properties-fieldsets-contentmanagementfieldset',
    viewModel: {
        type: 'administration-content-processes-tabitems-properties-fieldsets-contentmanagementfieldsetmodel'
    },
    ...
    items: [{
        ...
        items: [{
                    ...
                    'uiRouting_mode', {
                        uiRouting_mode: {
                            ...
                            bind: {
                                ...
                                value: '{theProcess.uiRouting_mode}'
                            }
                        }
                    })
            ]
            ...
            items: [CMDBuildUI.util.administration.helper.FieldsHelper.getCommonComboInput(
                'uiRouting_target', {
                    uiRouting_target: {
                        fieldcontainer: {
                            ...
                            listeners: {
                                beforerender: function () {
                                    ...
                                    vm.bind({
                                        mode: '{theProcess.uiRouting_mode}'
                                    }, function (data) {
                                        switch (data.mode) {
                                            case 'custompage':
                        ...
                        displayfield: {
                            bind: {
                                value: '{theProcess._uiRouting_target_description}'
                            },
                            listeners: {
                                beforerender: function () {
                                    var me = this;
                                    ...
                                    vm.bind({
                                        ...
                                        if (store) {
                                            var record = store.findRecord('name', this.get('theProcess.uiRouting_target'));
                                            if (record) {
                                                this.set('theProcess._uiRouting_target_description', record.get('description'));
                                            }
                                        }
                                    });
                        ...
                        combofield: {
                            ...
                            valueField: 'name',
                            bind: {
                                value: '{theProcess.uiRouting_target}'
                            },
                            listeners: {
                                beforerender: function () {
                                    var me = this;
            ...
            items: [{
                ...
                bind: {
                    hidden: '{theProcess.uiRouting_mode !== "custom"}'
                },
                items: [{
                    xtype: 'grid',
    ...
    parseAndeSetObjectRoutes: function (theProcess) {
        var vm = this.getViewModel();
        var customRoutings = null;
        if (theProcess.get('uiRouting_mode') === 'custom') {
            customRoutings = {};
            vm.get('customRoutingsStore').each(function (route) {
                customRoutings[route.get('action')] = route.get('value');
            });
            theProcess.set('uiRouting_target', null);
        }
        theProcess.set('uiRouting_custom', customRoutings);
    }
});