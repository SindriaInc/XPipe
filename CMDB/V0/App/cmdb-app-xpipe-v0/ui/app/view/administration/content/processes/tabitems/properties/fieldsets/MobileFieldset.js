Ext.define('CMDBuildUI.view.administration.content.processes.tabitems.properties.fieldsets.MobileFieldset', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.administration-content-processes-tabitems-properties-fieldsets-mobilefieldset',
    viewModel: {
        type: 'administration-content-processes-tabitems-properties-fieldsets-mobilefieldset'
    },
    hidden: true,
    bind: {
        ...
        items: [{
            ...
            items: [{
                ...
                items: [{
                    ...
                    bind: {
                        value: '{theProcess.barcodeSearchAttr}',
                ...
                hidden: true,
                bind: {
                    hidden: '{theProcess.barcodeSearchAttr == ""}'
                },
                ...
                items: [{
                    ...
                    bind: {
                        value: '{theProcess.barcodeSearchRegex}',
                        hidden: '{actions.view}'
                    }
                }, {
                    htmlEncode: true,
