            ...
            items: [
                ...
                CMDBuildUI.util.administration.helper.FieldsHelper.getCommonComboInput('parentField', {
                    parentField: {
                        ...
                        fieldLabel: CMDBuildUI.locales.Locales.administration.lookuptypes.type.form.fieldsets.generalData.inputs.parent.label, // the localized object for label of field
                        localized: {
