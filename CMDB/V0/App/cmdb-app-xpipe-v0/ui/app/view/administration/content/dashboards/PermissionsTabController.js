Ext.define('CMDBuildUI.view.administration.content.dashboards.PermissionsTabController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.administration-content-dashboards-permissionstab',
    ...
    onEditBtnClick: function (button, event, eOpts) {
        ...
        view.up('administration-content-dashboards-tabpanel').getViewModel().toggleEnableTabs(1);
    },
