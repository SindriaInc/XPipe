Ext.define('CMDBuildUI.view.administration.content.processes.tabitems.properties.PermissionsModel', {
    extend: 'Ext.app.ViewModel',
    alias: 'viewmodel.administration-content-processes-tabitems-properties-permissions',
    data: {
        actions: {
            view: true,
            edit: false,
    ...
    formulas: {
        ...
        proxyurl: {
            ...
            get: function (data) {
                if (this.get('theProcess').crudState !== 'C') {
                    return Ext.String.format('/roles/_ALL/grants/by-target/{0}/{1}', data.objectType.toLowerCase(), data.objectTypeName);
                }
            }
        }
    },
