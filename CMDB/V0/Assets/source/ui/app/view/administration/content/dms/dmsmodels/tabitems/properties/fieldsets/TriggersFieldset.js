Ext.define('CMDBuildUI.view.administration.content.dms.models.tabitems.properties.fieldsets.TriggersFieldset', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.administration-content-dms-models-tabitems-properties-fieldsets-triggersfieldset',

    controller: 'administration-content-dms-models-tabitems-properties-fieldsets-triggersfieldset',
                            ...
                            afterrender: function (cmp) {
                                Ext.asap(function () {
                                    ...
                                    editor.getSession().on('change', function (event, _editor) {
                                        ...
                                        var vm = me.up('administration-content-dms-models-tabitems-properties-properties').lookupViewModel();
                    ...
                    widget: {
                        ...
                        listeners: {
                            change: function (element, newValue, oldValue, eOpts) {
                                element.up('administration-content-dms-models-tabitems-properties-fieldsets-triggersfieldset').getViewModel().get('formTriggersStoreNew').getData().items[0].set(element.recordKey, element.checked);
                            }
                        }
                    }
                }, {
