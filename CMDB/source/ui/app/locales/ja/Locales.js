(function() {
    Ext.define('CMDBuildUI.locales.ja.Locales', {
        ...
        "bulkactions": {
            ...
            "edit": "選択したアイテムを編集",
            "missingfields": "正しいフォームバリデーションのために、次のフィールドを追加する必要があります: {0}",
        ...
        "emails": {
            ...
            "subject": "件名",
            "templateattachments": "このメールには、テンプレートによって自動的にアップロードされた添付ファイルが含まれています",
            "to": "宛先",
            "view": "ビュー"
        },
        "errors": {
            "actionnotallowed": "許可されていないアクション",
        ...
        "filters": {
            ...
            "type": "タイプ",
            "typeinput": "入力パラメータ",
            "typeorchoosetheattributename": "属性名選択または入力",
            "user": "ユーザー",
            "value": "値"
        },
        "gis": {
        ...
        "relations": {
            ...
            "attributes": "属性",
            "begindate": "開始日",
            "cardnotpresentmessage": "関連カードは使用できなくなりました。変更を続けるには、別のカードを選択する必要があります",
            "code": "コード",
            "deletedetail": "詳細削除",
            ...
            "errorexisting": "リレーション\"{0}\"はすでに存在します。新しいリレーションを作成する前に、既存のリレーションを編集するか、削除してください",
            "extendeddata": "拡張データ",
            "mditems": "アイテム",
