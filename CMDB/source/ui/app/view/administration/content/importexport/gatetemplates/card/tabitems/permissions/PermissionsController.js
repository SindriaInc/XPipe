Ext.define('CMDBuildUI.view.administration.content.importexport.gatetemplates.card.tabitems.permissions.PermissionsController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.administration-content-importexport-gatetemplates-card-tabitems-permissions-permissions',
    ...
    onEditBtnClick: function (button, event, eOpts) {
        ...
        view.up('administration-content-importexport-gatetemplates-tabpanel').getViewModel().toggleEnableTabs(3);
    },
    ...
    onSaveBtnClick: function (button) {
        ...
        Ext.Ajax.request({
            ...
            callback: function () {
                store.load();
                me.getView().up('administration-content-importexport-gatetemplates-tabpanel').getViewModel().toggleEnableTabs(3);
