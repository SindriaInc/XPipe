Ext.define('CMDBuildUI.view.administration.content.dashboards.card.builder.Column', {
    ...
    initComponent: function () {
        this.tpl = new Ext.XTemplate('<tpl for=".">',
            ...
            '<span class="draggable-tool" style="position:absolute;right: 85px; top: 5px"><div id="{[this.getToolId(values._id,\'edit\')]}" class="x-tool administration-tool" aria-disabled="false" data-qtip="{[this.getQtip(\'edit\')]}"><div data-event="edit" data-ref="toolEl" class="x-tool-tool-el {[CMDBuildUI.util.helper.IconHelper.getIconId("pencil-alt", "solid")]}"></div></div></span>',
            '<span class="draggable-tool" style="position:absolute;right: 65px; top: 5px"><div id="{[this.getToolId(values._id,\'open\')]}" class="x-tool administration-tool" aria-disabled="false" data-qtip="{[this.getQtip(\'open\')]}"><div data-event="open" data-ref="toolEl" class="x-tool-tool-el {[CMDBuildUI.util.helper.IconHelper.getIconId("external-link-alt", "solid")]}"></div></div></span>',
            '<tpl if="!this.isChartDisabled(values)">',
            '<span class="draggable-tool" style="position:absolute;right: 45px; top: 5px"><div id="{[this.getToolId(values._id,\'disable\')]}" class="x-tool administration-tool" aria-disabled="false" data-qtip="{[this.getQtip(\'disable\')]}"><div data-event="disable" data-ref="toolEl" class="x-tool-tool-el {[CMDBuildUI.util.helper.IconHelper.getIconId("ban", "solid")]}"></div></div></span>',
            '<tpl else>',
            '<span class="draggable-tool" style="position:absolute;right: 45px; top: 5px"><div id="{[this.getToolId(values._id,\'enable\')]}" class="x-tool administration-tool" aria-disabled="false" data-qtip="{[this.getQtip(\'enable\')]}"><div data-event="enable" data-ref="toolEl" class="x-tool-tool-el {[CMDBuildUI.util.helper.IconHelper.getIconId("check-circle", "regular")]}"></div></div></span>',
            '</tpl>',
            '<span class="draggable-tool" style="position:absolute;right: 25px; top: 5px"><div id="{[this.getToolId(values._id,\'clone\')]}" class="x-tool administration-tool" aria-disabled="false" data-qtip="{[this.getQtip(\'clone\')]}"><div data-event="clone" data-ref="toolEl" class="x-tool-tool-el {[CMDBuildUI.util.helper.IconHelper.getIconId("clone", "regular")]}"></div></div></span>',
            '<span class="draggable-tool" style="position:absolute;right: 5px; top: 5px"><div id="{[this.getToolId(values._id,\'delete\')]}" class="x-tool administration-tool" aria-disabled="false" data-qtip="{[this.getQtip(\'delete\')]}"><div data-event="delete" data-ref="toolEl" class="x-tool-tool-el {[CMDBuildUI.util.helper.IconHelper.getIconId("trash-alt", "solid")]}"></div></div></span>',
            '<tpl else>',
            '<span class="draggable-tool" style="position:absolute;right: 5px; top: 5px"><div id="{[this.getToolId(values._id,\'open\')]}" class="x-tool administration-tool" aria-disabled="false" data-qtip="{[this.getQtip(\'open\')]}"><div data-event="open" data-ref="toolEl" class="x-tool-tool-el {[CMDBuildUI.util.helper.IconHelper.getIconId("external-link-alt", "solid")]}"></div></div></span>',
            '</tpl>',
            '</div></td>',
            '</tr>',
            '<tr>',
