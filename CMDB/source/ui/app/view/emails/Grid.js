Ext.define('CMDBuildUI.view.emails.Grid', {
    ...
    columns: [{
        ...
        items: [{
            iconCls: 'attachments-grid-action ' + CMDBuildUI.util.helper.IconHelper.getIconId('envelope', 'regular'),
            getTip: function () {
            ...
            iconCls: 'attachments-grid-action ' + CMDBuildUI.util.helper.IconHelper.getIconId('reply', 'solid'),
            getTip: function () {
            ...
            iconCls: 'attachments-grid-action ' + CMDBuildUI.util.helper.IconHelper.getIconId('paper-plane', 'solid'),
            getTip: function () {
