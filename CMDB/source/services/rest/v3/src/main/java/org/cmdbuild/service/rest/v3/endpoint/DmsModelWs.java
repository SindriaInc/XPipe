...
public class DmsModelWs {
    ...
    public Object read(@HeaderParam(VIEW_MODE_HEADER_PARAM) String viewMode, @PathParam("classId") String classId) {
        ...
        return buildResponse(isAdminViewMode(viewMode) ? classService.getExtendedClass(classe, CQ_INCLUDE_INACTIVE_ELEMENTS, CQ_FOR_USER) : classService.getExtendedClass(classe, CQ_FOR_USER, CQ_FILTER_DEVICE));//TODO duplicate code with class ws, improve this
    }
