...
public class ClassAttributesWsV2 {
    ...
    public Object readMany(@PathParam("classId") String classId) {
        List list = classService.getUserAttributes(classId).stream()
    ...
    public Object serializeAttributeType(Attribute attribute) {
        return map(
                ...
                "group", attribute.hasGroup() ? translationService.translateAttributeGroupDescription(attribute.getOwner(), attribute.getGroup()) : null,
