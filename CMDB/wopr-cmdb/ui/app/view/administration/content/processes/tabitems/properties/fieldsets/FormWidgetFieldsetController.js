Ext.define('CMDBuildUI.view.administration.content.processes.tabitems.properties.fieldsets.FormWidgetFieldsetController', {
    ...
    onAddNewWidgetMenuBtn: function (grid, rowIndex, colIndex) {
        ...
        var widgets = vm.get('theProcess.widgets');
