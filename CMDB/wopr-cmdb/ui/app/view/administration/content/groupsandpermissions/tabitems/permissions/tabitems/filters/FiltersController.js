Ext.define('CMDBuildUI.view.administration.content.groupsandpermissions.tabitems.permissions.tabitems.filters.FiltersController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.administration-content-groupsandpermissions-tabitems-permissions-tabitems-filters-filters',
    mixins: [
    ...
    onEditBtnClick: function (button, e, eOpts) {
        ...
        this.toggleEnablePermissionsTabs(3);
