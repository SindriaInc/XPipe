Ext.define('CMDBuildUI.view.administration.content.gis.gisnavigationtrees.DomainsController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.administration-content-gis-gisnavigationtrees-domains',
        ...
        CMDBuildUI.util.Msg.confirm(
            ...
            function (btnText) {
                if (btnText.toLowerCase() === 'yes') {
                    ...
                    if (reason === 'notfound') {
                        var saveBtn = me.getView().up('administration-content-gisnavigationtrees-view').down('#saveBtn');
    ...
    onEdit: function (editor, context, eOpts) {
        var me = this,
            mainView = me.getView().up('administration-content-gisnavigationtrees-view'),
    ...
    onViewModeBtnClick: function (view, rowIndex, colIndex, column, event, record) {
        ...
        var content = {
            xtype: 'administration-content-gisnavigationtrees-viewmodeform',
            scrollable: 'y',
            viewModel: {
                data: {
                    record: record,
    ...
    privates: {
        ...
        addNode: function (parentNode, domain, linkedObject, isDirect, checkedItem) {
            ...
            if (newNode.subclassFilter && newNode.subclassFilter.length) {
                ...
                Ext.Array.forEach(subclasses, function (subclass) {
                    newNode[Ext.String.format('subclass_{0}_description', subclass)] = checkedItem.get(Ext.String.format('subclass_{0}_description', subclass));
                });
        ...
        nodeAppended: function () {
            ...
            this.lastAppendedNodeTimeout = new Ext.util.DelayedTask(function () {
                if (view && !view.destroyed) {
                    CMDBuildUI.util.Utilities.showLoader(false, view.down('#domainstree'));
                }
            }).delay(1000);
        },
        /**
        ...
        setPropertiesForUncheckedNode: function (node) {
            var me = this,
                view = me.getView(),
                mainView = view.up('administration-content-gisnavigationtrees-view');
