Ext.define('CMDBuildUI.view.administration.content.reports.PermissionsTabModel', {
    extend: 'Ext.app.ViewModel',
    alias: 'viewmodel.administration-content-reports-permissionstab',
    data: {
        actions: {
            view: true,
            edit: false,
    ...
    formulas: {
        ...
        proxyurl: {
            bind: {
                reportId: '{theReport._id}'
            },
            get: function (data) {
                if (this.get('theReport').crudState !== 'C') {
                    return Ext.String.format('/roles/_ALL/grants/by-target/report/{0}', data.reportId);
                }
            }
        }
    },
