<form action="{{ route('dashboard.pipelines.edit', $pipeline->id) }}" method="post" enctype="multipart/form-data">
    ...
    <div class="row justify-content-md-center mt-5">
        ...
        <div class="col-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="{{ trans('dashboard.pipelines.field.name') }}" name="name" value="{{ $pipeline->name }}" autocapitalize="words" required>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="form-group">
                ...
                <textarea class="form-control" placeholder="" name="content" autocapitalize="none">{{ $pipeline->content }}</textarea>
                <div id="editor"></div>
            </div>
        </div>
