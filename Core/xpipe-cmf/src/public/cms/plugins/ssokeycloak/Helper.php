...
class Helper
{
    ...
    {
        return env('SSO_KEYCLOAK_AUTH_BASE_URL', 'https://auth.sindria.org');
    }

    public static function getAuthApiBaseUrl() : string
    {
        return env('SSO_KEYCLOAK_AUTH_API_BASE_URL', 'https://auth.sindria.org/auth');
    }

    public static function getAuthRealm() : string
    {
        return env('SSO_KEYCLOAK_AUTH_REALM', 'sindria');
    }

    public static function getAuthClientId() : string
    {
        return env('SSO_KEYCLOAK_AUTH_CLIENT_ID');
    }

    public static function getAuthClientSecret() : string
    {
        return env('SSO_KEYCLOAK_AUTH_CLIENT_SECRET');
    }

    public static function getAuthCallback() : string
    {
        return env('SSO_KEYCLOAK_AUTH_CALLBACK_BASE', 'http://localhost/_') . '/wp-login.php?action=callback';
    }
    ...
    public static function getIdpOnlyToggle() : bool
    {
        return env('SSO_KEYCLOAK_IDPONLY_TOGGLE', false);
    }
}
