...
{{--        <web-terminal-component></web-terminal-component>--}}
...
{{--        </div>--}}
        ...
        <xdev-cli-component></xdev-cli-component>
...
{{--        <script src="{{ asset('static/js/bootstrap.min.js') }}"></script>--}}
        ...
        <script src="{{ asset('static/js/xterm.min.js') }}"></script>
        <script src="{{ asset('static/js/xterm-addon-fit.min.js') }}"></script>
            ...
            jQuery(function($){
                ...
                function connect_with_options(data) {
                    ...
                    var form = document.querySelector(form_id),
                        ...
                        url = "http://localhost:8888",
                        _xsrf = form.querySelector('input[name="_token"]');
