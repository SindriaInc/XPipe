 ...
 */
namespace Pipe\TemplateCatalog\Setup\Patch\Data;
...
use Pipe\TemplateCatalog\Setup\Category;
use Pipe\TemplateCatalog\Model\Virtual\Product;
...
class InstallVirtualProducts implements DataPatchInterface
{
   ...
   /** @var StoreManagerInterface  */
    ...
    {
        $this->categorySetup->install(['Pipe_TemplateCatalog::fixtures/Virtual/categories.csv']);
