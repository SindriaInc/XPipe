...
class SystemEnvHelper
{
    private const ALLOWED_KEYS = [
        ...
        'PIPELINES_DEDICATED_GITHUB_TENANT',
        'PIPELINES_DEDICATED_GITHUB_ORGANIZATION',
        'PIPELINES_DEDICATED_GITHUB_REPOSITORY',
        // Support envs
        'SUPPORT_SERVICEDESK_GITHUB_ORGANIZATION',
        'SUPPORT_SERVICEDESK_GITHUB_REPOSITORY',
        'SUPPORT_SERVICEDESK_GITHUB_PROJECT_NAME',
        'SUPPORT_SERVICEDESK_GITHUB_PROJECT_NUMBER',
        'SUPPORT_SERVICEDESK_GITHUB_PROJECT_STATUS_ID',
        'SUPPORT_SERVICEDESK_GITHUB_PROJECT_STATUS_OPTION_TRIAGE',
        'SUPPORT_SERVICEDESK_GITHUB_PROJECT_STATUS_OPTION_APPROVED',
        'SUPPORT_SERVICEDESK_GITHUB_PROJECT_STATUS_OPTION_IN_PROGRESS',
        'SUPPORT_SERVICEDESK_GITHUB_PROJECT_STATUS_OPTION_IN_REVIEW',
        'SUPPORT_SERVICEDESK_GITHUB_PROJECT_STATUS_OPTION_CLOSED',
        // Lab envs
