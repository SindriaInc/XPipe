...
MAGENTO_BASE_URL=https://dorjecurreli-api-pipelines-xpipe.sindria.org
...
MAGENTO_DB_HOST=pipelines-v1-api-collector-db.xpipe-dorjecurreli.svc.cluster.local
MAGENTO_DB_NAME=app
MAGENTO_DB_USER=user
MAGENTO_DB_PASSWORD=secret

# Elasticsearch configuration
ELASTICSEARCH_HOST=pipelines-v1-api-collector-idx.xpipe-dorjecurreli.svc.cluster.local
