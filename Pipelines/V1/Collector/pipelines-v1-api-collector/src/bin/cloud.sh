...
MAGENTO_DB_HOST=pipelines-v1-api-collector-db.${CLOUD_NAMESPACE}.svc.cluster.local
MAGENTO_DB_NAME=app
MAGENTO_DB_USER=user
MAGENTO_DB_PASSWORD=secret

# Elasticsearch configuration
ELASTICSEARCH_HOST=pipelines-v1-api-collector-idx.${CLOUD_NAMESPACE}.svc.cluster.local
