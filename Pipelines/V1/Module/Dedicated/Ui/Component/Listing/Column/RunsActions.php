...
namespace Pipelines\Dedicated\Ui\Component\Listing\Column;
...
{
    private const URL_PATH_SHOW = 'dedicated/pipeline_run/show';
    private const URL_PATH_STOP = 'dedicated/pipeline_run/stop';
    private const URL_PATH_DELETE = 'dedicated/pipeline_run/delete';
