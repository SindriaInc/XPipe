...
MAGENTO_DB_HOST=security-v1-api-collector-db.xpipe-cloud.svc.cluster.local
MAGENTO_DB_NAME=app
MAGENTO_DB_USER=user
MAGENTO_DB_PASSWORD=secret

# Elasticsearch configuration
ELASTICSEARCH_HOST=security-v1-api-collector-idx.xpipe-cloud.svc.cluster.local
