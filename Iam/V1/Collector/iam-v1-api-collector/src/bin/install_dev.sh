...
MAGENTO_BASE_URL=https://dev-iam-api-xpipe.sindria.org
...
MAGENTO_DB_HOST=iam-v1-api-collector-db.xpipe-dev.svc.cluster.local
MAGENTO_DB_NAME=app
MAGENTO_DB_USER=user
MAGENTO_DB_PASSWORD=secret

# Elasticsearch configuration
ELASTICSEARCH_HOST=iam-v1-api-collector-idx.xpipe-dev.svc.cluster.local
