...
class Controller
{
    ...
    public function __construct(Service $service)
    {
        ...
        $this->passport = Passport::init([
            'authServerUrl' => Helper::getAuthLegacyBaseUrl(),
    ...
    public function handle()
    {
        try {
            ...
            if ($this->needHandle()) {
                ...
                $this->service->createUserSession($user);
     ...
     * @return void
     */
    private function redirectIfUserLoggedIn() : void
    {
        if (is_user_logged_in()) {
            $redirect_to = user_admin_url();
            wp_safe_redirect($redirect_to);
            $this->refreshClient($redirect_to);
            exit;
        }
    }
